...
def test_add_column_compatibility():
    """
    ...
    How to run:
      ...
      python3 test_add_column_compat.py
    """
    uri = _load_observer_uri()

    print("Initializing PySeekDB connection (add_column compat)...")
    print("Connecting to", uri)
    try:
        conn = db.connect(uri)
    except Exception as e:
        print("Connection failed, please update uri in test_add_column_compat.py:", e)
        return

    table_name = "test_add_column_" + str(int(time.time()))
    ...
    print("✅ add_column compatibility test passed!")


if __name__ == "__main__":
    test_add_column_compatibility()
